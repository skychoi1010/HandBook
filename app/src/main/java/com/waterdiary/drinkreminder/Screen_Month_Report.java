...
public class Screen_Month_Report extends MasterBaseFragment
{
	...
	private void Body()
	{
		...
		/*Calendar s_cal2=Calendar.getInstance();
		s_cal2.setTimeInMillis(start_calendar.getTimeInMillis());
		s_cal2.add(Calendar.MONTH,-1);

		Calendar e_cal2=Calendar.getInstance();
		e_cal2.setTimeInMillis(end_calendar.getTimeInMillis());
		e_cal2.add(Calendar.MONTH,-1);

		Log.d("MIN_MAX_DATE : ","-->"+
				s_cal2.getTimeInMillis()+ " @@@ "+""+e_cal2.getTimeInMillis());*/
