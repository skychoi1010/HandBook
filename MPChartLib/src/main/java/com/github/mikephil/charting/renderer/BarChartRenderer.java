...
public class BarChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    protected void drawDataSet(Canvas c, IBarDataSet dataSet, int index) {
        ...
        for (int j = 0; j < buffer.size(); j += 4) {
            ...
            /*if(mRenderPaint.getColor()!=Color.parseColor("#a7dbd8"))
            {
                Paint tmp_mRenderPaint=new Paint();
                tmp_mRenderPaint.setColor(Color.parseColor("#a7dbd8"));

                c.drawRect(buffer.buffer[j], buffer.buffer[j + 1], buffer.buffer[j+2],
                    buffer.buffer[j+1]+50, tmp_mRenderPaint);
            }*/
            ...
            /*c.drawPath(RoundedRect(buffer.buffer[j], buffer.buffer[j + 1], buffer.buffer[j + 2],
                    buffer.buffer[j + 3],30,30,true),mRenderPaint);*/
